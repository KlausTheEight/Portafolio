                              ...
                              <div class="table-responsive">
                                  ...
                                  <table class="table table-striped" id="table_list">
                                      <thead class="thead-light">
                                          <th>nombre</th><th>proyecto_id</th><th>estado</th><th>Acciones</th>                                      </thead>
                                      <tbody>
...
?><tr>
            ...
            <td><?=$dato["estado"]?></td>
            <td><a href="<?=base_url()?>formulario_controller/view_update/<?=$dato["id"]?>" class="btn btn-warning btn-sm">Ver / modificar</a></td><td><a href="<?=base_url()?>formulario_controller/delete/<?=$dato["id"]?>" class="btn btn-danger btn-sm">Eliminar</a></td></tr><?php 
 } ?>
                                      </tbody>
                                  </table>
                              </div>
