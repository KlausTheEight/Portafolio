...
"><i class="fas fa-arrow-left"></i> Volver</a>
                        ...
                        <div class="col-xl-12">
                            <form method="post" action="<?php echo base_url().'tipo_controller/add'; ?>
">
                                <div class="row">
                    ...
                    <input required class="form-control" name="tipo" type="text">
                    </div>
                    
                    <div class="form-group">
                    <label class="form-control-label">TIPO DE CAMPO HTML</label>
                    <input required class="form-control" name="type" type="text">
                    </div>
                    
                    <div class="form-group">
                    <label class="form-control-label">ENVOLTORIO HTML</label>
                    <input required class="form-control" name="html_envoltorio" type="text">
                    </div>
                    
                    <div class="form-group">
                    <label class="form-control-label">OPCION HTML</label>
                    <input required class="form-control" name="html_opcion" type="text">
                    </div>
