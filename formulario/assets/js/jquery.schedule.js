...
;(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    add: function (parent, position, height, options) {
      ...
      var period = $('<div class="jqs-period" title="'+options.tooltip+'" data-toggle="tooltip" data-placement="top" data-html="true">' +
        '<div class="jqs-period-container">' + periodTime + periodTitle + periodRemove + periodDuplicate + '</div>' +
        '</div>').css({
        'top': position * this.periodPosition,
        'height': height * this.periodPosition
      }).attr('id', this.uniqId()).appendTo(parent);
      ...
      if (!this.isValid(period)) {
        ...
        this.settings.onDuplicatePeriod.call(this, period, this.element);        
        $(period).remove();
