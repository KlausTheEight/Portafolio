...
var Lang = A.Lang,
    ...
    CSS_SCHEDULER_EVENT_TOOLTIP = getCN('scheduler-event', 'tooltip'),
...
var SchedulerEvent = A.Component.create({
     ...
     * @static
     */
    PROPAGATE_ATTRS: ['allDay', 'startDate', 'endDate', 'content', 'color', 'colorBrightnessFactor', 'tooltip',
        'colorSaturationFactor', 'titleDateFormat', 'visible', 'disabled'],

    prototype: {
        EVENT_NODE_TEMPLATE: '<div data-toggle="tooltip" data-html="true" data-placement="left" title="" class="' + CSS_SCHEDULER_EVENT + '">' + '<div class="' +
        ...
        syncUI: function() {
            ...
            instance._uiSetTooltip(
                instance.get('tooltip'));
        ...
        _uiSetTooltip: function() {
            var instance = this;

            instance.get('node').attr('title', instance.get('tooltip'));
        },
