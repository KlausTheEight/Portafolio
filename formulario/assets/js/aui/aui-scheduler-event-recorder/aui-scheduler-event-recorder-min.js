...
var SchedulerEventRecorder = A.Component.create({
    ...
    prototype: {
        ...
        showPopover: function(node) {
            ...
            desde = startDate;            
            horasDesde = desde.getHours();
            horasDesde = ("0" + horasDesde).slice(-2);

            minutosDesde = desde.getMinutes();
            minutosDesde = ("0" + minutosDesde).slice(-2);

            hasta = endDate;
            horaHasta = hasta.getHours();
            horaHasta = ("0" + horaHasta).slice(-2);

            minutosHasta = hasta.getMinutes();
            minutosHasta = ("0" + minutosHasta).slice(-2);
            ...
            $(".titulo-completar").text("Agenda de horarios - Día "+dia+"/"+mes+" - Desde las "+horasDesde+":"+minutosDesde+" hasta las "+horaHasta+":"+minutosHasta);
            $.when(cupos().done(function(){
                modalShow();
            }));            
            return false;            
